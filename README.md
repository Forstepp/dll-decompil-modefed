Программа выполняет статический анализ `.dll` файлов и ищет сигнатуры (ключевые строки)
...
- Поиск основан на сигнатурах и строках, поэтому возможны ложные срабатывания;
